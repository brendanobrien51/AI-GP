# This script is a classic AirSim vision-debugging tool for contour inspection.
# It captures the forward camera feed, enhances the image, runs adaptive edge
# detection, finds contours, and draws every meaningful contour with a
# rectangularity score and area label.
# It does not try to fly through gates or control the drone beyond takeoff and
# landing. Its main purpose is to help you see what the vision pipeline is
# detecting and to tune contour thresholds, edge settings, and gate-shape scoring.
